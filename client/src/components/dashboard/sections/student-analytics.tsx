...
export function StudentAnalytics({ selectedCourse }) {
       ...
       <div className="flex justify-between items-start">
        <div>
           ...
           <p className="text-muted-foreground">
             Understanding who your students are for {selectedCourse}.
           </p>
        </div>
        <Button>
                           ...
                           {index > 0 && (
                            ...
                            <div 
                                style={{ 
                                    ...
                                    width: `${getFunnelBarWidth(item.count, studentFunnelData[0].count)}%`,
                                    minHeight: '40px'
                                }}
